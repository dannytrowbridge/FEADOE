...
anal = doe_analysis.analysis('PLT_T1')
...
## #                      {'THICK': 0.5, 'TEMP': 0.0, 'PRES': self.Pressure } )
    ...
    pp['000'] = point(0.0, 0.0, 0.0, {'THICK': th*2.0, 'TEMP': 0.0, 'PRES': self.Pressure } )
    pp['100'] = point(4.0, -3.0, 0.0, common_params)
    ...
    pp['001'] = point(0.0, 0.0, 3.0, {'THICK': th/3.0, 'TEMP': 0.0, 'PRES': self.Pressure } )
    pp['011'] = point(0.0, 5.0, 3.0, {'THICK': th*2.0, 'TEMP': 0.0, 'PRES': self.Pressure } )
    ...
    #self.add_block_face_join(ms['A'], FTAGS.MIN_U,
    #                               ms['B'], FTAGS.MIN_U,) 
