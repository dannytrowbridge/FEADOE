...
anal = doe_analysis.analysis('PLT_SIMP_T1')
...
## #                      {'THICK': 0.5, 'TEMP': 0.0, 'PRES': self.Pressure } )
    ...
    pp['100'] = point(2.0, 0.0, 0.0, common_params)
    pp['010'] = point(0.0, 2.0, 0.0, common_params)
    pp['110'] = point(2.0, 2.0, 0.0, common_params)
    



    pp['001'] = point(0.0, 0.0, 2.0, {'THICK': th/2.0, 'TEMP': 0.0, 'PRES': self.Pressure } )
    pp['011'] = point(0.0, 2.0, 2.0, {'THICK': th/2.0, 'TEMP': 0.0, 'PRES': self.Pressure } )
