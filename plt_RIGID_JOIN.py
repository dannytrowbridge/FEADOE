...
anal = doe_analysis.analysis('PLT_RS_')
...
## #                      {'THICK': 0.5, 'TEMP': 0.0, 'PRES': self.Pressure } )
    ...
    pp['001'] = point(-2.0, -1.0, 0.0, {'THICK': th, 'TEMP': 0.0, 'PRES': self.Pressure } )
    pp['011'] = point(-2.0, 3.0, 0.0, {'THICK': th, 'TEMP': 0.0, 'PRES': self.Pressure } )
