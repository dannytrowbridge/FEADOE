...
anal = doe_analysis.analysis('PLT_SMALL_zz')
...
## #                      {'THICK': 0.5, 'TEMP': 0.0, 'PRES': self.Pressure } )
    ...
    pp['100'] = point(1.0, 0.0, 0.0, common_params)
    pp['010'] = point(0.0, 1.0, 0.0, common_params)
    pp['110'] = point(1.0, 1.0, 0.0, common_params)
    



    pp['001'] = point(-1.0, 0.0, 0.0, {'THICK': th, 'TEMP': 0.0, 'PRES': self.Pressure } )
    pp['011'] = point(-1.0, 1.0, 0.0, {'THICK': th, 'TEMP': 0.0, 'PRES': self.Pressure } )
    ...
    glb = ms['B'].get_grid_list_from_tags(GTAGS.MAX_V)
    #glb = ms['B'].get_grid_list_from_tags(GTAGS.CENTER_W, glb)
